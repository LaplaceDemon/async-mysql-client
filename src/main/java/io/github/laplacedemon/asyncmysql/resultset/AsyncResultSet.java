...
//		this.nextRowPacket = nextRowPacket;
	...
	private int getColumnIndex(String columnLabel) {
		for(int i = 0; i < this.resultMySQLPacket.fieldPacketList().size(); i++) {
		    FieldPacket fieldPacket = this.resultMySQLPacket.fieldPacketList().get(i);
			if(fieldPacket.getOrgName().equals(columnLabel)) {
				return i;
			}
		}
	...
	public boolean next() throws SQLException {
		boolean next = false;
		if(rowPacketIterator.hasNext()) {
			next = true;
			this.nextRowPacket = rowPacketIterator.next();
		}
	...
	public String getString(int columnIndex) throws SQLException {
		...
		return this.nextRowPacket.values()[index];
	}
